...
class UpperRight(QFrame):
    def __init__(self):
        ...
        hbox1.addWidget(self.comp_label)
        ...
        comp_id = Company().id
        self.tr_shcode = Tr_Shcode(comp_id)
    ...
    def on_text_changed(self, text):
        ...
        Company().id = text
        self.comp_label.setText(text)
        print('u_right Company().id', Company().id)
    ...
    def update_table(self):
        ...
        self.dfs = self.tr_shcode.fetch()
        # Wait for the event to be set
        self.tr_shcode.event.wait()
    ...
    def update_chart(self, dfs):
        ...
        fig = go.Figure(
            ...
            data=[
                ...
                go.Bar(x=x, y=y_bar, yaxis='y2', name='cvolume', marker=dict(color='gray'))
            ],
            layout={
